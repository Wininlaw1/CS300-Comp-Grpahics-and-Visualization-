...
void SceneManager::LoadSceneTextures()
{
	...
	//2 texture carpet
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Carpet.jpg",
		"carpet");

	//3 texture window
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Window.jpg",
		"Window");
	//4 texture bed sheet
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Fabric.jpg",
		"Fabric");

	//5 tetxure pillow
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Pillow.jpg",
		"Pillow");

	//6 texture wood for dresser
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Wood.jpg",
		"Wood");

	//7 pink bin dresser
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Pink.jpg",
		"Pink");

	//8 purple bin dresser
	bReturn = CreateGLTexture(
		"../7-1_FinalProjectMilestones/textures/Purple.jpg",
		"Purple");
...
void SceneManager::SetupSceneLights() {
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 100.0f, 0.0f); // High position
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.3f, 0.3f, 0.3f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 1.0f, 0.95f, 0.8f); // Warm sunlight 
...
void SceneManager::RenderScene()
{
	...
	// Code for white background plane rednering 

	scaleXYZ = glm::vec3(20.0f, 1.0f, 10.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 6.0f, -3.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	// SetShaderColor(1, 1, 1, 1); //white
	m_basicMeshes->DrawPlaneMesh();



	// Code for bed rendering 
	scaleXYZ = glm::vec3(6.0f, 8.0f, 2.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 90.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(11.0f, 1.0f, -1.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	// Code for pillow rendering 
	scaleXYZ = glm::vec3(3.0f, 1.0f, 2.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 90.0f;
	ZrotationDegrees = -80.0f;
	positionXYZ = glm::vec3(13.0f, 2.0f, -1.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
		ZrotationDegrees,
		positionXYZ);
	//SetShaderColor(0, 1, 1, 1); //blue light
	SetShaderTexture("Pillow");
	m_basicMeshes->DrawBoxMesh();

	//code for the plane toward the camera for rendering
	scaleXYZ = glm::vec3(2.0f, 1.0f, 2.9f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(12.0f, 0.0f, 6.8f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	//SetShaderColor(1.0, 0.5, 0, 1); // color orangeish brown
	m_basicMeshes->DrawPlaneMesh();

	//Second plane for bookshelf toward the wall in white 
	scaleXYZ = glm::vec3(2.0f, 1.0f, 2.9f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	...
	SetTransformations(
		...
		ZrotationDegrees,
		positionXYZ);
	//SetShaderColor(1.0, 0.5, 0, 1);
	SetShaderTexture("Wood");
	SetShaderMaterial("wood");
	m_basicMeshes->DrawPlaneMesh();

	// top of the bookshelf plane rendering
	scaleXYZ = glm::vec3(2.0f, 0.2f, 2.0f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(12.0f, 2.9f, 5.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	// code for middle plane for bookshelf
	scaleXYZ = glm::vec3(1.0f, 1.0f, 2.0f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(11.0f, 2.0f, 5.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	// Code for Bin in dresser purple one top shelf
	scaleXYZ = glm::vec3(1.0f, 2.0f, 1.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 90.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(11.0f, 2.3f, 5.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	//SetShaderColor(0.5, 0, 0.5, 1); //purple
	m_basicMeshes->DrawBoxMesh();



	// code for second bin for dresser on top shelf 
	scaleXYZ = glm::vec3(1.0f, 2.0f, 1.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 90.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(11.0f, 2.3f, 6.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	//SetShaderColor(1, 0, 1, 1); //pinkish
	m_basicMeshes->DrawBoxMesh();




	//code for rendering bottom shelf bin 
	scaleXYZ = glm::vec3(1.0f, 2.0f, 1.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 90.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(11.0f, 1.0f, 5.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
	...
	YrotationDegrees = 90.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(11.0f, 1.0f, 6.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
		...
		positionXYZ);
	SetShaderTexture("Purple");
	//SetShaderColor(0.5, 0, 0.5, 1); //pinkish
	m_basicMeshes->DrawBoxMesh();

	//Window plane above the bed 
	scaleXYZ = glm::vec3(4.0f, 1.0f, 2.5f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	...
	// Code for white background plane side rendering
	scaleXYZ = glm::vec3(10.0f, 1.0f, 10.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 90.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(15.0f, 6.0f, 0.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
